...
struct ContentView: View {
    ...
    @State private var NAMES = ["Ada Lovelace",
                         ...
                         "Jean Liu",
                         "Tammarrian Rogers"]
    @State private var IMAGES = ["Ada Lovelace",
                          "Admiral Grace Hopper",
                          "The ENIAC Team",
                          "Sister Mary Kenneth Keller",
                          "Radia Perlman",
    ...
    var body: some View {
        ...
        HStack {
            ...
            Button {
                ...
                repeat {
                    newCurrentIndex = Int.random(in: 0..<NAMES.count)
